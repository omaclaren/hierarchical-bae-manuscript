...
adjfile = h5py.File('2DF002.h5','r')
sat = adjfile['primary'][-1,100::,1]
for i in range(0,len(sat)):
    if sat[i] > 1.0 :
        sat[i] = 0.0
sat = sp.reshape(sat,(80,100))

temp = adjfile['element'][-1,100::,1]



temp = sp.reshape(temp,(80,100))
sat = sp.reshape(sat,(80,100))
...
plt.xticks(sp.arange(25.0-0.5, 125.0-0.5, 25.0))
xlabels = [item.get_text() for item in ax.get_xticklabels()]
xlabels = sp.arange(0,2500,500)
ax.set_xticklabels(xlabels)
plt.yticks(sp.arange(0.0-0.5, 100.0-0.5, 20.0))
