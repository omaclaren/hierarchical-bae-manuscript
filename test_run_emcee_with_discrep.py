...
if load_discrepancy:
    discrep = IC.ModelDiscrep(process_space=process_space, measurement_space=measurement_space,
                              coarse_process_model=process_model_medium, data_model=synthetic_model_fine)
    #else:
    #    discrep = IC.ModelDiscrep(process_space=process_space, measurement_space=measurement_space)
...
bmodel = IC.BayesModel(name='test_bayes_model_med_fine_tighter_cap_mcmc_with_combined_discrep_incl_outliers',
